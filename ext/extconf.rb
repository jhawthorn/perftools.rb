...
def sys(cmd)
  ...
  unless ret = xsystem(cmd)
    raise "#{cmd} failed, please report to perftools@tmm1.net with pastie.org link to #{CWD}/mkmf.log and #{CWD}/src/google-perftools-1.7/config.log"
  end
  ret
end
...
perftools = File.basename('google-perftools-1.7.tar.gz')
